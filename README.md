...
Quickly setup docker env variables and drupal local settings
```
composer env-docker
```

Then start your docker env with:
```
make up
```

Login to php docker container shell with
```
make shell php
```
...
Visit your env at:
```
http://opencv.localhost:6736 ## default http
http://opencv.localhost:6737 ## dashboard
```

Make your codebase dev friendly
```
composer env-opencv-dev
```
